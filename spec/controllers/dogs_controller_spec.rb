...
describe DogsController do
  ...
  describe "GET new" do
    it "assigns a new dog as @dog" do
      ...
      assigns(:dog).should be_a_new(Dog)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created dog as @dog" do
        post :create, {:dog => valid_attributes}, valid_session
        assigns(:dog).should be_a(Dog)
        assigns(:dog).should be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved dog as @dog" do
        ...
        Dog.any_instance.stub(:save).and_return(false)
        post :create, {:dog => { "name" => "invalid value" }}, valid_session
        assigns(:dog).should be_a_new(Dog)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested dog" do
        dog = Dog.create! valid_attributes
        # Assuming there are no other dogs in the database, this
        # specifies that the Dog created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Dog.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => dog.to_param, :dog => { "name" => "MyString" }}, valid_session
      end
      ...
      it "redirects to the dog" do
        dog = Dog.create! valid_attributes
        put :update, {:id => dog.to_param, :dog => valid_attributes}, valid_session
        response.should redirect_to(dog)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the dog as @dog" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Dog.any_instance.stub(:save).and_return(false)
        put :update, {:id => dog.to_param, :dog => { "name" => "invalid value" }}, valid_session
        assigns(:dog).should eq(dog)
      end
